...
pub struct App {
    ...
    // Search/DIAMOND blast state
    pub search_menu_open: bool,
    pub search_menu_idx: usize,
    pub blast_target_open: bool,
    pub blast_target_idx: usize,
    pub blast_file_open: bool,
    pub blast_file_path: String,
...
impl App {
    pub fn new(
        ...
        App {
            ...
            search_menu_idx: 0,
            blast_target_open: false,
            blast_target_idx: 0,
            blast_file_open: false,
            blast_file_path: String::new(),
